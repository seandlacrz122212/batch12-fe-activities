const UNSPLASH_API_KEY = "b491e86a6957b396f44f1e15e41d3d242e17aa982607f161b95defd195c7f4dd"; //unsplash developers
...
function getBackground() {
  fetch(UNSPLASH_URL)
    ...
    .then(json => {
      const image = json;
      if (image.urls && image.urls.full && image.location) { // should show place of bg
